...
export const Wallet = ()=>{
    return <div className="max-h-screen">
        ...
        <div className="fixed min-h-48 w-[50%] mt-[4%]  items-center rounded-2xl ml-[3%] mr-[3%]  bg-white ">
        ...
        <div className="fixed text-white min-h-32 w-[94%] h-[60%] rounded-xl mr-[3%] bg-white  font-bold text-2xl mt-[40%] ml-[3%]">
            <div><SearchB/></div>
            <div><UserP/></div>
        </div>
    </div>
