        ...
        <div className="w-auto">
            ...
            <div className="flex">
                <div className="w-[133px] h-[133px]   rounded-full ">
                    <img className="w-72 rounded-full" src='..\src\assets\kirito_kun_by_kazumony_dfpafs4-fullview.jpg'/>
                </div>
            ...
            <div className="text-white text-xl font-bold">Prayag Ahire</div>
            ...
            <div className="flex">
                ...
                <div className="text-gray-500">Born Augest 2,2003</div>
                </div>
                ...
                <div className="text-gray-500">joined september 2023</div>
                </div>
            </div>
            </div>
