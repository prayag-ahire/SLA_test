...
export const Login = ()=>{
    ...
    <div><button className="py-2 rounded-full bg-white mt-10 text-gray w-[299px]" onClick={googleLogin}>Sign up with Google</button></div>
    ...
    <div><button className="py-2 rounded-full bg-white mt-10 text-gray w-[299px]" onClick={()=>{navigate('/Loginpass')}}>Next</button></div>
