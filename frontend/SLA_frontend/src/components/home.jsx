...
export const Home = ()=>{
    return <div className="grid grid-cols-12 gap-5  fixed bg-black h-full">
        <div className="grid pl-32 col-start-1 col-end-4">
            ...
            <div className="text-white font-bold text-xl pl-4">Home</div>
            </div>
            ...
            <div className="text-white font-bold text-xl pl-4">Meassage</div>
            </div>
            ...
            <div className="text-white font-bold text-xl pl-4">Profile</div>
            </div>
        ...
        <div className="col-start-4 col-end-9 border h-screen ">
            <div className=" grid grid-cols-2 divide-x h-14">
                <div className="text-white  text-center content-center">For you</div>
                <div className="text-white  text-center content-center">Messages</div>
            </div>
            <div>
        ...
        <div className="col-start-9 col-end-12 h-screen w-screen">
            ...
            <div className="mt-4 rounded-xl w-[348px] h-[144px] border-[1px]">
                <div className="text-white font-bold text-xl ml-2 mt-2">Subscribe to Premium</div>
                <div className="text-white text-wrap ml-2 mt-2">Subscribe to unlock new features and if eligible, receive a share of ads revenue.</div>
            </div>
            <div className="mt-4 rounded-xl border-[1px] w-[348px] h-[180px] "><div className="text-xl font-bold text-white ml-2">What’s happening</div></div>
            <div className="mt-4 rounded-xl border-[1px] w-[348px] h-[450px] "></div>
            <div className="mt-4 mb-44 rounded-xl border-[1px] w-[348px] h-[295px] "></div>
            <div className=""></div>
            </div>
        </div>
    </div>
