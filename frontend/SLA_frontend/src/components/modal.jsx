...
export const Modal = ()=>{
    ...
    return <div className="fixed inset-0 bg-pink bg-[#5B708366] bg-opacity-50 backdrop-blur-20 flex justify-center items-center ">
        ...
        <div className="place-self-start flex justify-center items-center mt-3 ml-3 rounded-full hover:bg-slate-900 w-8 h-8 "><button onClick={()=>{navigate('/')}}><svg xmlns="http://www.w3.org/2000/svg" color="white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
