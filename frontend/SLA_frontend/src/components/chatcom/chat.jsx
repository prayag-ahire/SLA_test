  ...
  return (
    <div className='flex flex-col h-full'>
      {!selectedConversation ? (
        ...
        <>
          <div className='flex flex-row bg-neutral-900 h-10 items-center text-white px-4'>
            <div className='flex-grow min-w-0'>
              <div className='truncate text-xl font-semibold'>{selectedConversation.fullName}</div>
            </div>
    ...
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM18.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
          ...
          <div className='flex-grow bg-slate-300 overflow-auto'>
            <Messages />
          </div>
